...
import pandas as pd
df = pd.read_parquet("/home/dannie/data/sft/train.parquet")
...
df_2 = pd.read_parquet("/home/dannie/data/visual/train.parquet")
...
project_root = "/data1/dannie/projects/ARLArena"
...
data_paths = ["/home/dannie/data/sft/train.parquet"]
...
local_path = copy_to_local(cfg.model.partial_pretrain, use_shm=cfg.model.get("use_shm", False))
