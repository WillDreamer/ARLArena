...
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/train.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/test.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/aime.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/aime_2025.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/olympiad_bench.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/math.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/amc.parquet
wget -P datasets/deepscaler https://huggingface.co/datasets/hkust-nlp/DeepScaler-Data/resolve/main/minerva.parquet
