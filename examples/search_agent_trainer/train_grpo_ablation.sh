...
# GRPO config (GiGPO-specific configs commented out)
# mode="mean_std_norm" # "mean_norm" or "mean_std_norm" (only for GiGPO)
# enable_similarity=True # enable similarity-based GiGPO (only for GiGPO)
# similarity_thresh=0.9 # similarity threshold for GiGPO (only for GiGPO)
